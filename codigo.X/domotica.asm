...
BUCLE		
		...
		BTFSC	DOMOTICA_STATUS, DOM_ESPERANDO_INPUT
		GOTO 	BUCLE
...
L3
		...
		MOVLW	0x40 				; 
		SUBWF	0x34,W 				; Si el ultimo buffer es 0x40
		BTFSC	STATUS,Z			; valida el código y pone DOM_ESPERANDO_INPUT = false
		GOTO	ESPERAR_CODIGO_DESDE_DESBLOQUEADO		    ;			
		
		MOVF 	0x34, F
		BTFSS	STATUS,Z			; Si el ultimo bufer es distinto de 0x00
...
INCORRECTO
		...
		CLRF 	0x33
		CLRF 	0x34
		BCF 	DOMOTICA_STATUS, DOM_ESPERANDO_INPUT
		GOTO	FIN_TECLADO
ESPERAR_CODIGO_DESDE_DESBLOQUEADO
		CLRF 	0x31
		CLRF 	0x32
		CLRF 	0x33
		CLRF 	0x34
